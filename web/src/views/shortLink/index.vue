<template>
  <div>
    <div class="n-layout-page-header">
      <n-card :bordered="false" title="短链接">
      ...
      >
        <template #tableTitle>
          <n-button
            ...
            v-if="hasPermission(['/shortLink/edit'])"
          >
            <template #icon>
              <n-icon>
                <PlusOutlined />
          ...
          <n-button
            ...
            class="min-left-space"
            v-if="hasPermission(['/shortLink/delete'])"
          >
            <template #icon>
              <n-icon>
                <DeleteOutlined />
          ...
          <n-button
            ...
            @click="handleExport"
            class="min-left-space"
            v-if="hasPermission(['/shortLink/export'])"
          >
            <template #icon>
              <n-icon>
                <ExportOutlined />
...
<script lang="ts" setup>
  ...
  import { List, Export, Delete, Status } from '@/api/shortLink';
